...
all:
	...
	@echo "  build-production                      - build production version of plugin"
	@echo "  push-production                       - push production version of plugin to hub.docker.com registry (${REGISTRY_PRODUCTION})"
	@echo "  enable-production                     - enable production version of plugin on local machine"
	@echo "  uninstall-production                  - uninstall production version of plugin from local machine"
